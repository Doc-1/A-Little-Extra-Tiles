...
public class Four extends DrawCharacter {
	
	public Four(Facing facing, BufferBuilder bufferbuilder, RenderWorldLastEvent event) {
		
	}
	
	public Four(Vec3d start, Facing facing, double scale, BufferBuilder bufferbuilder, RenderWorldLastEvent event) {
		this.scale = scale;
		this.facing = facing;
	...
	public ArrayList<Vec3d> vecList() {
		...
		vec.add(new Vec3d(0.08, 0, 0.04));
		vec.add(new Vec3d(0.03, 0, 0));

...
public class K extends Char {
	...
	public K(Vec3d start, Facing facing, double scale, BufferBuilder bufferbuilder, RenderWorldLastEvent event) {
		this.scale = scale;
		this.facing = facing;
	...
	public void printChar(Vec3d start) {
		...
		bufferbuilder.pos((x + 0.04) - d0 - 0.001, (y) - d1 - 0.001, (z) - d2 - 0.001).color(red, green, blue, alpha).endVertex();
		bufferbuilder.pos((x) - d0 - 0.001, (y) - d1 - 0.001, (z + 0.04) - d2 - 0.001).color(red, green, blue, alpha).endVertex();

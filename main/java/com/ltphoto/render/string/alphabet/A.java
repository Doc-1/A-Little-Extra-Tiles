...
public class A extends Char {
	...
	public void printChar(Vec3d start) {
		...
		bufferbuilder.pos((x) - d0 - 0.001, (y) - d1 - 0.001, (z) - d2 - 0.001).color(red, green, blue, alpha).endVertex();
		...
		bufferbuilder.pos((x + 0.03) - d0 - 0.001, (y) - d1 - 0.001, (z + 0.04) - d2 - 0.001).color(red, green, blue, alpha).endVertex();
		bufferbuilder.pos((x + 0.03) - d0 - 0.001, (y) - d1 - 0.001, (z + 0.01) - d2 - 0.001).color(red, green, blue, alpha).endVertex();

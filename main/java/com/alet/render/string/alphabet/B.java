...
public class B extends DrawCharacter {
	
	public B(Facing facing, BufferBuilder bufferbuilder, RenderWorldLastEvent event) {
		
	}
	
	public B(Vec3d start, Facing facing, double scale, BufferBuilder bufferbuilder, RenderWorldLastEvent event) {
		this.scale = scale;
		this.facing = facing;
	...
	public ArrayList<Vec3d> vecList() {
		...
		vec.add(new Vec3d(0.075, 0, 0.025));
		vec.add(new Vec3d(0.07, 0, 0.04));
		vec.add(new Vec3d(0.06, 0, 0.05));
		vec.add(new Vec3d(0.042, 0, 0.04));
		vec.add(new Vec3d(0.04, 0, 0.025));
		vec.add(new Vec3d(0.04, 0, 0));
		vec.add(new Vec3d(0.04, 0, 0.025));
		vec.add(new Vec3d(0.037, 0, 0.04));
		vec.add(new Vec3d(0.03, 0, 0.05));
		vec.add(new Vec3d(0.012, 0, 0.04));
		vec.add(new Vec3d(0.005, 0, 0.025));
		vec.add(new Vec3d(0, 0, 0));

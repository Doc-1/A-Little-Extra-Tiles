...
public class Nine extends DrawCharacter {
	
	public Nine(Facing facing, BufferBuilder bufferbuilder, RenderWorldLastEvent event) {
		
	}
	
	public Nine(Vec3d start, Facing facing, double scale, BufferBuilder bufferbuilder, RenderWorldLastEvent event) {
		this.scale = scale;
		this.facing = facing;
	...
	public ArrayList<Vec3d> vecList() {
		...
		vec.add(new Vec3d(0.045, 0, 0.01));

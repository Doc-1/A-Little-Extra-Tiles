...
import com.alet.littletiles.gui.SubGuiGrabberAlet;
...
public class ItemLittleGrabberAlet extends Item implements ICreativeRendered, ILittleTile {
	...
	public static class PixelMode extends SimpleMode {
		...
		@Override
		@SideOnly(Side.CLIENT)
		public SubGuiGrabberAlet getGui(EntityPlayer player, ItemStack stack, LittleGridContext context) {
			return new SubGuiGrabberAlet(this, stack, 140, 140, context) {
				...
				public void createControls() {
					...
					LittlePreview preview = ItemLittleGrabberAlet.SimpleMode.getPreview(stack);
					...
					controls.add(new GuiColorPickerAlet("picker", 0, 67, color, LittleTiles.CONFIG.isTransparencyEnabled(getPlayer()), LittleTiles.CONFIG.getMinimumTransparency(getPlayer())));
				...
				public LittlePreview getPreview(LittleGridContext context) {
					...
					if (!selected.isEmpty() && selected.getItem() instanceof ItemBlock) {
						...
						return ItemLittleGrabberAlet.SimpleMode.getPreview(stack);
				}
		...
		public void addExtraInformation(NBTTagCompound nbt, List<String> tooltip) {
			...
			LittlePreview preview = ItemLittleGrabberAlet.SimpleMode.getPreview(nbt);
	...
	public static class PlacePreviewMode extends GrabberMode {
		...
		public void littleBlockAction(World world, TileEntityLittleTiles te, LittleTile tile, ItemStack stack, BlockPos pos, NBTTagCompound nbt) {
			...
			ItemLittleGrabberAlet.PlacePreviewMode.setPreview(stack, previews);
		}

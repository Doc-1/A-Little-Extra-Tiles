...
public class SubGuiLittleRope extends SubGuiConfigure {
    ...
    public void createControls() {
        ...
        float lightLevel = nbt.hasKey("light") ? nbt.getFloat("light") : 240F;
        ...
        controls.add(new GuiAnalogeSlider("light", 100, 95, 94, 10, lightLevel, 0, 240));

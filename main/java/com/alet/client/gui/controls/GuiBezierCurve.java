...
public class GuiBezierCurve extends GuiParent {
	...
	protected void renderContent(GuiRenderHelper helper, Style style, int width, int height) {
		...
		RenderUtils.drawCubicBezier(new Point2i((p0.x + 4) * multi, (p0.y + 4)
		        * multi), new Point2i((p1.x * multi), (p1.y + 4) * multi), new Point2i((p2.x * multi), (p2.y + 4)
		                * multi), new Point2i((p3.x + 4) * multi, (p3.y + 4) * multi));

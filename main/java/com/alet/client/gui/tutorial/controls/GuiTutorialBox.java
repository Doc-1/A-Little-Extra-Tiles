...
public class GuiTutorialBox extends GuiParent {
	...
	public void openedControls() {
		...
		addControl(new GuiButton("close", TextFormatting.DARK_GRAY + "" + TextFormatting.BOLD + "X", width
		        - 24, 0, 12, 10) {
			@Override
			public void onClicked(int x, int y, int button) {
		...
		addControl(new GuiButton("next", TextFormatting.DARK_GRAY + "" + TextFormatting.BOLD + ">", width - 23, height
		        - 22, 11, 10) {
		...
		addControl(new GuiButton("back", TextFormatting.DARK_GRAY + "" + TextFormatting.BOLD + "<", 0, height
		        - 22, 11, 10) {
		...
		addControl(new GuiLabel("maxPages", TextFormatting.DARK_GRAY + "" + TextFormatting.BOLD + "/"
		        + tutorialMap.size(), 50, height - 21));

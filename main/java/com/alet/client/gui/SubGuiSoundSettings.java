...
public class SubGuiSoundSettings extends SubGui {
	...
	public void createControls() {
		...
		GuiComboBoxHeight sounds1 = new GuiComboBoxHeight("sounds1", 255, 0, 85, 10, soundList);
		sounds1.select(littleSoundPlayerParserALET.CHSound1);
		controls.add(sounds1);
		
		GuiComboBoxHeight sounds2 = new GuiComboBoxHeight("sounds2", 255, 21, 85, 10, soundList);
		sounds2.select(littleSoundPlayerParserALET.CHSound2);
		controls.add(sounds2);
		
		GuiComboBoxHeight sounds3 = new GuiComboBoxHeight("sounds3", 255, 42, 85, 10, soundList);
		sounds3.select(littleSoundPlayerParserALET.CHSound3);
		controls.add(sounds3);
		
		GuiComboBoxHeight sounds4 = new GuiComboBoxHeight("sounds4", 255, 63, 85, 10, soundList);
		sounds4.select(littleSoundPlayerParserALET.CHSound4);
		controls.add(sounds4);
		
		GuiComboBoxHeight sounds5 = new GuiComboBoxHeight("sounds5", 255, 84, 85, 10, soundList);
		sounds5.select(littleSoundPlayerParserALET.CHSound5);
		controls.add(sounds5);
		
		GuiComboBoxHeight sounds6 = new GuiComboBoxHeight("sounds6", 255, 105, 85, 10, soundList);
		sounds6.select(littleSoundPlayerParserALET.CHSound6);
		controls.add(sounds6);
		
		GuiComboBoxHeight sounds7 = new GuiComboBoxHeight("sounds7", 255, 126, 85, 10, soundList);
		sounds7.select(littleSoundPlayerParserALET.CHSound7);
		controls.add(sounds7);
		
		GuiComboBoxHeight sounds8 = new GuiComboBoxHeight("sounds8", 255, 147, 85, 10, soundList);
		sounds8.select(littleSoundPlayerParserALET.CHSound8);
		controls.add(sounds8);
		
		GuiComboBoxHeight sounds9 = new GuiComboBoxHeight("sounds9", 255, 168, 85, 10, soundList);
		sounds9.select(littleSoundPlayerParserALET.CHSound9);
		controls.add(sounds9);
		
		GuiComboBoxHeight sounds10 = new GuiComboBoxHeight("sounds10", 255, 168, 85, 10, soundList);
		sounds10.select(littleSoundPlayerParserALET.CHSound10);
		controls.add(sounds10);
		
		GuiComboBoxHeight sounds11 = new GuiComboBoxHeight("sounds11", 255, 168, 85, 10, soundList);
		sounds11.select(littleSoundPlayerParserALET.CHSound11);
		controls.add(sounds11);
		
		GuiComboBoxHeight sounds12 = new GuiComboBoxHeight("sounds12", 255, 168, 85, 10, soundList);
		sounds12.select(littleSoundPlayerParserALET.CHSound12);
		controls.add(sounds12);
		
		GuiComboBoxHeight sounds13 = new GuiComboBoxHeight("sounds13", 255, 168, 85, 10, soundList);
		sounds13.select(littleSoundPlayerParserALET.CHSound13);
		controls.add(sounds13);
		
		GuiComboBoxHeight sounds14 = new GuiComboBoxHeight("sounds14", 255, 168, 85, 10, soundList);
		sounds14.select(littleSoundPlayerParserALET.CHSound14);
		controls.add(sounds14);
		
		GuiComboBoxHeight sounds15 = new GuiComboBoxHeight("sounds15", 255, 168, 85, 10, soundList);
		sounds15.select(littleSoundPlayerParserALET.CHSound15);
		controls.add(sounds15);
		
		GuiComboBoxHeight sounds16 = new GuiComboBoxHeight("sounds16", 255, 168, 85, 10, soundList);
		sounds16.select(littleSoundPlayerParserALET.CHSound16);
		controls.add(sounds16);
		
		GuiTextfield search1 = new GuiTextfieldSearch("search", "", 167, 0, 80, 10, "sounds1");
		controls.add(search1);
		
		GuiTextfield search2 = new GuiTextfieldSearch("search", "", 167, 21, 80, 10, "sounds2");
		controls.add(search2);
		
		GuiTextfield search3 = new GuiTextfieldSearch("search", "", 167, 42, 80, 10, "sounds3");
		controls.add(search3);
		
		GuiTextfield search4 = new GuiTextfieldSearch("search", "", 167, 63, 80, 10, "sounds4");
		controls.add(search4);
		
		GuiTextfield search5 = new GuiTextfieldSearch("search", "", 167, 84, 80, 10, "sounds5");
		controls.add(search5);
		
		GuiTextfield search6 = new GuiTextfieldSearch("search", "", 167, 105, 80, 10, "sounds6");
		controls.add(search6);
		
		GuiTextfield search7 = new GuiTextfieldSearch("search", "", 167, 126, 80, 10, "sounds7");
		controls.add(search7);
		
		GuiTextfield search8 = new GuiTextfieldSearch("search", "", 167, 147, 80, 10, "sounds8");
		controls.add(search8);
		
		GuiTextfield search9 = new GuiTextfieldSearch("search", "", 167, 168, 80, 10, "sounds9");
		controls.add(search9);
		
		GuiTextfield search10 = new GuiTextfieldSearch("search", "", 167, 168, 80, 10, "search10");
		controls.add(search10);
		
		GuiTextfield search11 = new GuiTextfieldSearch("search", "", 167, 168, 80, 10, "search11");
		controls.add(search11);
		
		GuiTextfield search12 = new GuiTextfieldSearch("search", "", 167, 168, 80, 10, "search12");
		controls.add(search12);
		
		GuiTextfield search13 = new GuiTextfieldSearch("search", "", 167, 168, 80, 10, "search13");
		controls.add(search13);
		
		GuiTextfield search14 = new GuiTextfieldSearch("search", "", 167, 168, 80, 10, "search14");
		controls.add(search14);
		
		GuiTextfield search15 = new GuiTextfieldSearch("search", "", 167, 168, 80, 10, "search15");
		controls.add(search15);
		
		GuiTextfield search16 = new GuiTextfieldSearch("search", "", 167, 168, 80, 10, "search16");
		...
		controls.add(new GuiLabel("CH10:", 140, 170));
		controls.add(new GuiLabel("CH11:", 140, 170));
		controls.add(new GuiLabel("CH12:", 140, 170));
		controls.add(new GuiLabel("CH13:", 140, 170));
		controls.add(new GuiLabel("CH14:", 140, 170));
		controls.add(new GuiLabel("CH15:", 140, 170));
		controls.add(new GuiLabel("CH16:", 140, 170));

...
public class GuiSoundTimeline extends GuiParent {
	...
	public GuiSoundTimeline(String name, int x, int y, int width, int height, int duration, List<TimelineChannel> channels, ISoundHandler handler) {
	...
	public GuiSoundTimeline setSidebarWidth(int width) {
	...
	public GuiSoundTimeline setDuration(int duration) {

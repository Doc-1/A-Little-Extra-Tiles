...
public class RenderLeashConnection extends Render<EntityLeadConnection> {
	...
	@Override
	public boolean shouldRender(EntityLeadConnection livingEntity, ICamera camera, double camX, double camY, double camZ) {
	...
	protected void renderLeash(EntityLeadConnection entityConnection, double x, double y, double z, float entityYaw, float partialTicks) {
		Entity entity = entityConnection.getLeashHolder();
		if (entity != null) {
			y = y - (1.6D) * 0.78D;

...
public class DragShapeTriangle extends DragShape {
	...
	public List<GuiControl> getCustomSettings(NBTTagCompound nbt, LittleGridContext context) {
		...
		controls.add(new GuiStateButton("direction", nbt.getInteger("direction"), 5, 35, "facing: y north", "facing: y east", "facing: y south", "facing: y west", "facing: x north", "facing: x down", "facing: x south", "facing: x up", "facing: z up", "facing: z east", "facing: z down", "facing: z west"));
		return controls;
	}

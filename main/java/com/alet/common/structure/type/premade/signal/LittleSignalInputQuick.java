...
public class LittleSignalInputQuick extends LittleSignalInput {
	...
	public void render(SurroundingBox box, LittleBox overallBox, List<LittleRenderBox> cubes) {
		...
		LittleRenderBox front = (LittleRenderBox) new LittleRenderBox(cube, null, LittleTiles.dyeableBlock, 0).setColor(ColorUtils.BLUE);
		...
		LittleRenderBox frontTop = (LittleRenderBox) new LittleRenderBox(cube, null, LittleTiles.dyeableBlock, 0).setColor(ColorUtils.BLUE);
		...
		LittleRenderBox frontBottom = (LittleRenderBox) new LittleRenderBox(cube, null, LittleTiles.dyeableBlock, 0).setColor(ColorUtils.BLUE);
		...
		LittleRenderBox frontRight = (LittleRenderBox) new LittleRenderBox(cube, null, LittleTiles.dyeableBlock, 0).setColor(ColorUtils.BLUE);
		...
		LittleRenderBox frontLeft = (LittleRenderBox) new LittleRenderBox(cube, null, LittleTiles.dyeableBlock, 0).setColor(ColorUtils.BLUE);
	...
	public static class LittleStructureTypeInputQuick extends LittleStructureTypeNetwork {
		...
		public List<PlacePreview> getSpecialTiles(LittlePreviews previews) {
			...
			result.add(new PlacePreviewFacing(box, facing, ColorUtils.BLUE));
			return result;
		}
		...
		public List<RenderBox> getRenderingCubes(LittlePreviews previews) {
			...
			cubes.add(new RenderBox(size * 2, 0.5F - size, 0.5F - size, size * 2.5F, 0.5F + size, 0.5F + size, LittleTiles.dyeableBlock).setColor(ColorUtils.BLUE));
			return cubes;
		}

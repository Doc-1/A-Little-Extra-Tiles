...
public class LittleSignalOutputQuick extends LittleSignalOutput {
    ...
    public void render(SurroundingBox box, LittleBox overallBox, List<LittleRenderBox> cubes) {
        ...
        LittleRenderBox left = (LittleRenderBox) new LittleRenderBox(cube, null, LittleTiles.dyeableBlock, 0).setColor(ColorUtils.ORANGE);
        ...
        LittleRenderBox right = (LittleRenderBox) new LittleRenderBox(cube, null, LittleTiles.dyeableBlock, 0).setColor(ColorUtils.ORANGE);
        ...
        LittleRenderBox bottom = (LittleRenderBox) new LittleRenderBox(cube, null, LittleTiles.dyeableBlock, 0).setColor(ColorUtils.ORANGE);
        ...
        LittleRenderBox top = (LittleRenderBox) new LittleRenderBox(cube, null, LittleTiles.dyeableBlock, 0).setColor(ColorUtils.ORANGE);

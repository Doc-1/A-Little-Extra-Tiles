...
public class LittleMagnitudeComparator1 extends LittleStructurePremade {
    
    private String output = "1";
    private String logic = "equals";
    
    public LittleMagnitudeComparator1(LittleStructureType type, IStructureTileList mainBlock) {

...
public class LittleMagnitudeComparator4 extends LittleStructurePremade {
	
	private String output = "1111";
	private String logic = "equals";
	
	public LittleMagnitudeComparator4(LittleStructureType type, IStructureTileList mainBlock) {

package com.alet.common.entities;

import javax.vecmath.Vector3d;

import com.alet.common.structures.type.LittleAdvancedSeat;
...
public class EntitySit extends Entity implements IWorldPositionProvider, INoPushEntity {
    ...
    public EntitySit(LittleAdvancedSeat chair, World world, double x, double y, double z) {
        super(world);

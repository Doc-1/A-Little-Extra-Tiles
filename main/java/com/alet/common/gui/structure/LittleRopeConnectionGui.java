...
public class LittleRopeConnectionGui extends LittleStructureGuiParser {
    
    public LittleRopeConnectionGui(GuiParent parent, AnimationGuiHandler handler) {
    ...
    protected LittleStructure parseStructure(LittlePreviews previews) {
        LittleRopeConnection structure = createStructure(LittleRopeConnection.class, null);
    ...
    protected LittleStructureType getStructureType() {
        return LittleStructureRegistry.getStructureType(LittleRopeConnection.class);
    }

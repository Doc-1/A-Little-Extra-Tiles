package com.alet.common.gui.overlay;
        ...
        if (!Minecraft.getMinecraft().gameSettings.showDebugInfo) {
            {
                ...
                GuiRenderHelper.instance.drawStringWithShadow("Y", -15, -50, ColorUtils.RGBAToInt(
                ...
                if (direction < 45 && direction > -45) {
                    GlStateManager.pushMatrix();
                    GlStateManager.rotate(180, 0, 0, 1);
                    GuiRenderHelper.instance.drawStringWithShadow("X", -30, -15, ColorUtils.RGBAToInt(
                        new Color(255, 255, 255, 255)));
                    GlStateManager.popMatrix();
                ...
                if (direction < 45 && direction > -45) {
                    GlStateManager.pushMatrix();
                    GlStateManager.rotate(180, 0, 0, 1);
                    GuiRenderHelper.instance.drawStringWithShadow("Z", -30, -15, ColorUtils.RGBAToInt(
                        new Color(255, 255, 255, 255)));
                    GlStateManager.popMatrix();

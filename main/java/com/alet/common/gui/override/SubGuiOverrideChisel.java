...
public class SubGuiOverrideChisel extends SubGuiOverride {
    ...
    public void modifyControls(SubGui gui) {
        ...
        box.tutorialMap.add(new TutorialTip(chiselGui.get("picker"), "leftout", "This is the color picker. With it you can set the color your chisel will place in."));
        box.tutorialMap.add(new TutorialTip(chiselGui
        ...
        box.tutorialMap.add(new TutorialTip(picker.get("r"), "leftout", "This is the red color slider."));
        box.tutorialMap.add(new TutorialTip(picker.get("g"), "leftout", "This is the green color slider."));
        box.tutorialMap.add(new TutorialTip(picker.get("b"), "leftout", "This is the blue color slider."));
        box.tutorialMap.add(new TutorialTip(picker.get("a"), "leftout", "This is the alpha slider. How transparent the color is."));
        box.tutorialMap.add(new TutorialTip(picker.get("s"), "leftout", "This is the shader slider. It allows you to easly change how dark or light a color is."));
        box.tutorialMap.add(new TutorialTip(picker

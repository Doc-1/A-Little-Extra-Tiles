...
import com.alet.gui.SubGuiErrorMessage;
...
public class LittleTilesClient extends LittleTilesServer {
	...
	public void loadSidePost() {
		...
		overlay.add(new OverlayControl(new GuiAxisIndicatorAletControl("axis", 0, 0), OverlayPositionType.RIGHT_CORNOR).setShouldRender(() -> TapeRenderer.inInv));

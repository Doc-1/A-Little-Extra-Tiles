...
public class LittleAbsoluteBox implements IGridBased {
	...
	public LittleVec getDoubledCenterAlet(BlockPos pos) {
		Vec3d vec = new Vec3d((box.maxX + box.minX) / 2.0, (box.maxY + box.minY) / 2.0, (box.maxZ + box.minZ) / 2.0);

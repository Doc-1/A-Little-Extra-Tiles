package com.docvin.alet.common.packets;
...
public class PacketSendSound extends CreativeCorePacket {
    ...
    public void executeClient(EntityPlayer player) {
        ...
        SoundEvent sound = new SoundEvent(new ResourceLocation(Objects.requireNonNull(note).getResourceLocation(instermentName)));
        if (local)

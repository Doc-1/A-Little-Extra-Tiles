package com.docvin.alet.client.sounds;
...
public enum Notes {
    ...
    E5((float) Math.pow(2F, 4F / 12F), (float) Math.pow(2F, 1.0f), 12, "E5", "alet:block.note.-high"),
    ...
    private final float pitchOut;
    private final float pitchIn;
    private final String pitchName;
    private final String resourceLocation;
    private final int pos;

    Notes(float pitchOut, float pitchIn, int pos, String pitchName, String resourceLocation) {

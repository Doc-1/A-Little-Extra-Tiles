...
public class GuiControlHighlighter extends GuiControl {
    ...
    protected void renderContent(GuiRenderHelper helper, Style style, int width, int height) {
        if (!empty) {
            helper.drawRect(0, 0, 1, (this.height - 2) + 1, ColorUtils.RED);
            helper.drawRect(0, 0, this.width, 1, ColorUtils.RED);
            helper.drawRect(this.width - 1, 1, this.width, (this.height - 2) + 1, ColorUtils.RED);
            helper.drawRect(1, (this.height - 2), this.width, (this.height - 2) + 1, ColorUtils.RED);
        }
    }

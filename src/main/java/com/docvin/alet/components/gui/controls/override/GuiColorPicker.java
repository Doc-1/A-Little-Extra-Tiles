...
public class GuiColorPicker extends com.creativemd.creativecore.common.gui.controls.gui.GuiColorPicker {
    ...
    public GuiColorPicker(String name, int x, int y, Color color, boolean hasAlpha, int alphaMin) {
        ...
        //Red Slider
        sliderR = (new GuiColoredSteppedSlider("r", 8, 0, 84, 5, this, ColorUtils.ColorPart.RED) {
            @Override
        ...
        //Green Slider
        sliderG = (new GuiColoredSteppedSlider("g", 8, 10, 84, 5, this, ColorUtils.ColorPart.GREEN) {
            @Override
            public void mouseMove(int posX, int posY, int button) {
                super.mouseMove(posX, posY, button);
                if (grabbedSlider) {
        ...
        //Blue Slider
        sliderB = (new GuiColoredSteppedSlider("b", 8, 20, 84, 5, this, ColorUtils.ColorPart.BLUE) {
            @Override
            public void mouseMove(int posX, int posY, int button) {
                super.mouseMove(posX, posY, button);
                if (grabbedSlider) {
        ...
        //Shader Slider
        sliderS = (new GuiColoredSteppedSlider("s", 8, 40, 84, 5, this, ColorUtils.ColorPart.SHADE) {
            @Override
            public void mouseMove(int posX, int posY, int button) {

...
public class GuiAnimationViewer extends com.creativemd.littletiles.client.gui.controls.GuiAnimationViewer {
    ...
    public boolean onKeyPressed(char character, int key) {
        ...
        if (Keyboard.isKeyDown(gSettings.keyBindForward.getKeyCode())) {
            x += mod * Math.sin(-this.rotY.aimed() * ((float) Math.PI / 180F));
            z += mod * Math.cos(this.rotY.aimed() * ((float) Math.PI / 180F));
        ...
        if (Keyboard.isKeyDown(gSettings.keyBindRight.getKeyCode())) {
            x -= mod * Math.cos(-this.rotY.aimed() * ((float) Math.PI / 180F));
            z -= mod * Math.sin(this.rotY.aimed() * ((float) Math.PI / 180F));

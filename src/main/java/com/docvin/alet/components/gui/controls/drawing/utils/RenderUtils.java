package com.docvin.alet.components.gui.controls.drawing.utils;
...
public class RenderUtils {
    ...
    public static void drawCubicBezier(Point2i p0, Point2i p1, Point2i p2, Point2i p3, int color, int backColor) {
    ...
    public static Point2i cubicBezier(Point2i p0, Point2i p1, Point2i p2, Point2i p3, double t, @NotNull Point2i pFinal) {

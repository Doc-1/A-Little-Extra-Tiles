...
public class GuiDepressedCheckBox extends GuiCheckBox {
    ...
    protected void renderContent(GuiRenderHelper helper, Style style, int width, int height) {
        ...
        if (value) {
            helper.drawRect(-3, -3, 1 - 3, (this.height - 2) + 1 - 3, 0xff373737);
            helper.drawRect(-3, -3, this.width - 3, 1 - 3, 0xff373737);
            helper.drawRect(this.width - 1 - 3, -3, this.width - 3, 1 - 3, 0xff8b8b8b);
            helper.drawRect(this.width - 1 - 3, 1 - 3, this.width - 3, (this.height - 2) + 1
                    - 3, 0xffffffff);
            helper.drawRect(1 - 3, (this.height - 1) - 1 - 3, this.width - 3, (this.height - 2) + 1
                    - 3, 0xffffffff);
            helper.drawRect(-3, (this.height - 2) - 3, 1 - 3, (this.height - 2) + 1 - 3, 0xff8b8b8b);

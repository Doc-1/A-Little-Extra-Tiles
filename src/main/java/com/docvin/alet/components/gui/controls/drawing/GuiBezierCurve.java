...
public class GuiBezierCurve extends GuiParent {
    ...
    public GuiBezierCurve(String name, GuiControl p0LockOn, GuiControl p3LockOn, int width, int height, int color, int backColor) {
    ...
    protected void renderContent(GuiRenderHelper helper, Style style, int width, int height) {
        ...
        RenderUtils.drawCubicBezier(new Point2i((p0.x + 4) * multi, (p0.y + 4) * multi),
                ...
                new Point2i((p3.x + 4) * multi, (p3.y + 4) * multi), color, backColor);
    ...
    private static class GuiDragNode extends GuiControl {

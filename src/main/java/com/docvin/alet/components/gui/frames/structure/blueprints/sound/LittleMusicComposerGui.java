package com.docvin.alet.components.gui.frames.structure.blueprints.sound;
...
import com.docvin.alet.client.sounds.Sound;
import com.docvin.alet.client.utils.CopyUtils;
import com.docvin.alet.common.utils.GuiLayerUtils;
import com.docvin.alet.components.gui.controls.labeling.GuiLongTextField;
import com.docvin.alet.components.gui.frames.messages.SubGuiNoPathMessage;
import com.docvin.alet.components.gui.frames.messages.SubGuiTooManyChannels;
...
public class LittleMusicComposerGui extends LittleStructureGuiParser {
    ...
    public void importMidi() {
        ...
        String extension = "";
        if (midiFile.exists()) {
            extension = midiFile.getName().substring(midiFile.getName().lastIndexOf(".") + 1);
            if (!file.text.equals(""))

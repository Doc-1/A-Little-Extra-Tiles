package com.docvin.alet.components.gui.controls.parents;
...
public class GuiColoredPanel extends GuiParent {

    public static Style panelStyle;
    public Color borderColor;
    public Color backColor;

    public GuiColoredPanel(String name, int x, int y, int width, int height, int borderRed, int borderGreen, int borderBlue, int backRed, int backGreen, int backBlue) {
    ...
    public GuiColoredPanel(String name, int x, int y, int width, int height, Color border, Color background) {
        super(name, x, y, width, height);
